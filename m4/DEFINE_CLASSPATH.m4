...
AC_DEFUN([DEFINE_CLASSPATH], [[{

#
# The block that contains this comment is the expansion of the
# DEFINE_CLASSPATH macro.
#]dnl
m4_ifdef(
  [DEFINE_CLASSPATH_HAS_BEEN_CALLED],
  [gatbps_fatal([
    DEFINE_CLASSPATH has already been called
  ])],
  [m4_define([DEFINE_CLASSPATH_HAS_BEEN_CALLED])])[]dnl
m4_if(
  m4_eval([$# != 0]),
  [1],
  [gatbps_fatal([
    DEFINE_CLASSPATH requires exactly 0 arguments
